...
from hyteratak.kaitai import telemetry_protocol
from hyteratak.kaitai import radio_registration_service
from hyteratak.kaitai import text_message_protocol
from hyteratak.kaitai import data_delivery_states
from hyteratak.kaitai import location_protocol
from hyteratak.kaitai import radio_control_protocol
from hyteratak.kaitai import data_transmit_protocol
...
class HyteraDmrApplicationProtocol(KaitaiStruct):
    ...
    def _read(self):
        ...
        if not self.message_footer == b"\x03":
            raise kaitaistruct.ValidationNotEqualError(
                b"\x03", self.message_footer, self._io, "/seq/3"
            )
    ...
    def is_reliable_message(self):
        ...
        self._m_is_reliable_message = (self.message_header & 128) != 0
        return (
            self._m_is_reliable_message
            if hasattr(self, "_m_is_reliable_message")
            else None
    ...
    def message_type(self):
        ...
        self._m_message_type = KaitaiStream.resolve_enum(
            HyteraDmrApplicationProtocol.MessageHeaderTypes, (self.message_header & 127)
        )
        return self._m_message_type if hasattr(self, "_m_message_type") else None
