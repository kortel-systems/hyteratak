...
from hyteratak.kaitai import datetimestring
from hyteratak.kaitai import radio_ip
from hyteratak.kaitai import gpsdata
from hyteratak.kaitai import intervalstring
...
class LocationProtocol(KaitaiStruct):
    ...
    def _read(self):
        self.opcode_header = self._io.read_u2be()
    ...
    def opcode(self):
        ...
        self._m_opcode = self.opcode_header >> 8
        return self._m_opcode if hasattr(self, "_m_opcode") else None
    ...
    def opcode_header_int(self):
        ...
        self._m_opcode_header_int = KaitaiStream.resolve_enum(
            LocationProtocol.LpSpecificTypes, self.opcode_header
        )
        return (
